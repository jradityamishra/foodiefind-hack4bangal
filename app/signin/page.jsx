  ...
  return (
    <>
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <div class="mt-6">
            <button class="w-full bg-sky-500 px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-head-color rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
              Sign up
            </button>
          </div>
